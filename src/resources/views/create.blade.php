                                  ...
                                  <div class="card bg-dark text-white" style="border-radius: 1rem;">
                                    <div class="card-body p-5 text-center">
                                      ...
                                      <div class="mb-md-5 mt-md-4 pb-5">
                                        ...
                                        {{-- <div class="form-outline form-white mb-4">
                                          <input type="password" id="typePasswordX"name="password.confirm" id="password.confirm" placeholder="Password"  class="form-control form-control-lg" />
                                        ...
                                        {{-- </div>
                                        <div class="form-outline form-white mb-4">
                                          <label for="phone" style="" tabindex="0" class="form-label picture form-control-lg">Select your better phone</label>
                                          <input class="form-control" type="file"   accept="image/*" name="image" id="phone" />
                                        </div>    
                                                     --}}
                                        <button class="btn btn-outline-light btn-lg login col-12 px-5" value="Save"  type="submit"></button>
                                                                                   
                                      </div>
                          
                                      <div>
                                        <p class="mb-0">Do you have an account? <a href="{{route('user.index')}}" class="text-white-50 fw-bold">Login In</a>
                                        </p>
                                      </div>
